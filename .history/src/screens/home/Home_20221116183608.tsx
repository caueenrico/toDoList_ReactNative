...
export function Home() {
  ...
  const [quantidadedeTasksConcluidas, setQuantidadeDeTasksConcluidas] = useState<number>(0)
  ...
  function observandoAsCheck(tasks :ITasksProps){
    tasks.map((item) =>{ if(tasks.isChecked = true){
      setQuantidadeDeTasksConcluidas(+1)
    }})
  }
